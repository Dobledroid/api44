...
const setUserData_membresias = (id, total, currentURL, tipoMembresiaID, correo, ID_UnicoMembresia, fechaVencimiento, ID_membresiaUsuario) => {
  userData.userID = id;
  userData.total = total;
  userData.currentURL = currentURL;
  userData.tipoMembresiaID = tipoMembresiaID;
...
const getUserData_membresias = () => {
  return userData;
};

export { setUserData_membresias, getUserData_membresias };
